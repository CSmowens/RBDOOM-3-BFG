...
idVec4 HelperScalar::TransformCoords(const idVec4 &v, const idVec4 &m)
{
   idVec4 result;
...
idVec4 HelperScalar::TransformCoords(const idVec3 &v, const idVec4 &m)
{
   idVec4 result;
...
void BoxTestSetupScalar::Init(const idRenderMatrix &viewMatrix, const idRenderMatrix &projMatrix, const idRenderMatrix &viewportMatrix, float fov, float occludeeSizeThreshold)
{
